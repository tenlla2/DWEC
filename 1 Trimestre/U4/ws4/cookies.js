...
let cargarCookies = () => {
    ...
    '<button id="delete">Borrar Cookie</button>' + '<button class="font" onclick="zoomIn()">Aumenta el tamaño del texto</button>'+
    '<button class="font" onclick="zoomOut()">Disminuye el tamaño del texto</button>';
